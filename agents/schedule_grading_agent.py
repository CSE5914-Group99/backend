...
class ScheduleScore(BaseModel):
    ...
    class_scores: list[ClassScore] = Field(description="Map of class ID to individual class scores")
...
def merge_schedule_scores(left: ScheduleScore | None, right: ScheduleScore | None) -> ScheduleScore | None:
    ...
    merged_class_scores = (left.class_scores or []) + (right.class_scores or [])
